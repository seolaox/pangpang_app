...
class _MapWidgetState extends ConsumerState<MapWidget> {
  ...
  // 병원 위치로 지도 이동
  Future<void> _moveToHospitalLocation(AnimalHospitalEntity hospital) async {
    ...
    try {
      ...
      debugPrint("지도 이동 완료: ${hospital.name}");
